...
public final class Purchase_ implements EntityInfo<Purchase> {
    ...
    /** To-many relation "items" to target entity "Item". */
    public static final RelationInfo<Purchase, Item> items = new RelationInfo<>(Purchase_.__INSTANCE, Item_.__INSTANCE,
            new ToManyGetter<Purchase>() {
                @Override
                public List<Item> getToMany(Purchase entity) {
                    return entity.items;
                }
            },
            Item_.purchaseId,
            new ToOneGetter<Item>() {
                @Override
